...
abstract class DoubleProperty<T> extends Property<T, double> {
  ...
  Map<T, String>? mapSymbolsAr;
  Map<T, String>? mapSymbolsSp;
  Map<T, String>? nameAr;
  Map<T, String>? nameSp;
  Map<T, UnitSystemType>? systemType;
  Map<T, UnitSystemNeed>? systemNeed;
  Map<T, String>? backendKey;
  ...
  DoubleProperty(
    ...
    for (var conversionNode in _nodeList) {
      _unitList.add(
          Unit(conversionNode.name,systemType: systemType?[conversionNode.name] ,backendKey: backendKey?[conversionNode.name] ,
                systemNeed:systemNeed?[conversionNode.name],nameAr: nameAr?[conversionNode.name] ,
                nameSp: nameSp?[conversionNode.name] , symbolAr: mapSymbolsAr?[conversionNode.name],
                symbolSp: mapSymbolsSp?[conversionNode.name] , symbol: mapSymbols?[conversionNode.name],));
    }
  }
